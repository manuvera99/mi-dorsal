...
export const seedDefaults = mutation({
  ...
  handler: async (ctx) => {
    ...
    const defaults = [
      ...
      { name: "Alcanza tu Meta", slug: "alcanzatumeta", type: "scraper" as const, description: "Agenda de carreras populares del sureste (Murcia, Alicante, Almería, Albacete). Plataforma de inscripciones Innovative Sports Research S.L. (alcanzatumeta.es/calendario.php)", baseUrl: "https://www.alcanzatumeta.es" },
      ...
      { name: "Carreraspopulares", slug: "carreraspopulares", type: "scraper" as const, description: "Calendario popular de carreras en España con filtro de circuito homologado (carreraspopulares.com)", baseUrl: "https://carreraspopulares.com" },
