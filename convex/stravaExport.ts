...
export const upsertActivityInternal = internalMutation({
  args: {
    ...
    // -----------------------------------------------------------------
    // Campos extra de Strava (añadidos 2026-09-08) — para reports
    // -----------------------------------------------------------------
    ...
    workoutType: v.optional(v.number()),
  ...
  handler: async (ctx, args) => {
    ...
    if (existing) {
      ...
      await ctx.db.patch(existing._id, {
        ...
        sufferScore: args.sufferScore,
        hasPower: args.hasPower,
        averageWatts: args.averageWatts,
        maxWatts: args.maxWatts,
        weightedAverageWatts: args.weightedAverageWatts,
        maxCadence: args.maxCadence,
        utcOffsetSeconds: args.utcOffsetSeconds,
        externalId: args.externalId,
        averageGradeAdjustedSpeed: args.averageGradeAdjustedSpeed,
        gradeAdjustedDistance: args.gradeAdjustedDistance,
        embedToken: args.embedToken,
        averageTemp: args.averageTemp,
        minTemp: args.minTemp,
        maxTemp: args.maxTemp,
        feelsLikeTemp: args.feelsLikeTemp,
        averageWindSpeed: args.averageWindSpeed,
        precipitationIntensity: args.precipitationIntensity,
        weatherObservationTime: args.weatherObservationTime,
        laps: args.laps,
        segmentEfforts: args.segmentEfforts,
        rawStravaDetail: args.rawStravaDetail,
        syncedAt: Date.now(),
      });
