...
- [x] **Plan de negocio + roadmap de infra** (8 sep 2026) — análisis completo de costes a escala, break-even, comparativa de pricing y roadmap de upgrades por servicio. **`docs/BUSINESS_PLAN.md`** (5 escenarios de ingresos 4-patas) + **`docs/INFRA_ROADMAP.md`** (techos por servicio + 3 fixes urgentes: Vercel Hobby→Pro, buzón Zoho `hola@mi-dorsal.com`, Resend cap 100/día).
