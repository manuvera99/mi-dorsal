...
const MOMENTS = [
  ...
  },
  {
    ...
    body: "Re-subes tu export de Strava una vez y las 312 actividades del 2024 entran, los PRs se actualizan y un análisis ilimitado de tu perfil de corredor te dice dónde apretar para bajar de 1:25 en la Behobia 2027.",
    pro: true,
  },
];
